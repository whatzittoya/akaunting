...
use Throwable;
use Modules\DoubleEntry\Jobs\Journal\ImportJournalEntry;

class ImportAccount extends Job
{
    protected $class;
    ...
    {
        return $this->fromExcel($this->class, $this->request, trans_choice('double-entry::general.chart_of_accounts', 2));
    }
     ...
     * @return array
     */
    public function fromExcel($class, $request, $translation)
    {
        try {
            ...
            if (should_queue()) {
                ...
                $this->dispatch(new ImportJournalEntry($rows));
